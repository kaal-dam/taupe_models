...
import BDD.Add;
import BDD.TagInsertFile;
import Main.MainClass;


/**
 * classe de selection dans l explorateur de fichier des gts a importer
 * 
 * @author damien
 * 
 */
public class GTSFileChooser extends JPanel implements ActionListener {
	...
	JFileChooser				fc;
	/**
	 * le fichier recuperer par le filechooser
	 */
	File						filePath;
		...
		if (result == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				valid.addActionListener(new ActionListener() {
					@Override
					public void actionPerformed(ActionEvent e) {
						String nomFile = jTextNom.getText() + ".gts";
						File fileDest = new File("./model/" + nomFile);
						try {
	...
	/**
	 * copie le fichier donner en parametre dans un dossier specifique
	 * 
	 * @param source
	 *            fichier source
	 * 
